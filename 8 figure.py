...
G=1 
r1= np.array([-1.002,0.004])
r2= np.array([1.002,-0.004])
r3= np.array([0,0])
v1= np.array([0.348,0.530])
v2= np.array([0.348,0.530])
v3= np.array([-0.697,-1.061])
h=0.01
...
plt.plot(x1,y1,color='r',label='Mass 1')
plt.plot(x2,y2,color='b',label='Mass 2')
plt.plot(x3,y3,color='g',label="Mass 3")
plt.xlabel('x axis')
plt.ylabel('y axis')
plt.title("3-body problem 8 figure",fontsize=25)
legend = plt.legend()
...
#%% Phase space ( it is for y component , similarly we can define for x too)

m1=1; m2=1;m3=1;G=1;h=0.01
...
plt.subplot(3,3,1)
plt.plot(r1y,v1v, color='r')
plt.scatter(r1y[0],v1v[0],color='green',label='Initial Point')
plt.scatter(r1y[-1],v1v[-1],color='black',label='Final Point')
plt.xlabel('y1')
plt.ylabel('vy1')
plt.legend()
plt.grid()
...
plt.subplot(3,3,2)
plt.plot(r2y,v2v, color='b',linestyle='-')
plt.scatter(r2y[0],v2v[0],color='red',label='Initial Point')
plt.scatter(r2y[-1],v2v[-1],color='black',label='Final Point')
plt.xlabel('y2')
plt.ylabel('vy2')
plt.legend()
plt.grid()
...
plt.subplot(3,3,3)
plt.plot(r3y,v3v, color='g')
plt.scatter(r3y[0],v3v[0],color='red',label='Initial Point')
plt.scatter(r3y[-1],v3v[-1],color='black',label='Final Point')
plt.xlabel('y3')
plt.ylabel('vy3')
plt.legend()

plt.grid()
plt.suptitle("Figure 8 Phase space- Y components",fontsize=25)
